function p01Func() {
    ...
    */document.getElementById("problem").innerHTML="<p>I'm looking for a type of pancake originating from the Indian subcontinent, made from a fermented batter. It is somewhat similar to a crepe in appearance.</p>"
      document.getElementById("design").setAttribute("src","images/dosa/dosaDesign.jpg");
      
      document.getElementById("js").setAttribute("src","images/dosa/dosa1.jpg");
      document.getElementById("another").setAttribute("src","images/dosa2.jpg");
...
function checkUncheck3(){
  ...
  function p02Func(){
    ...
    document.getElementById("design").setAttribute("src","images/jujeh/jujehDesign.jpg");
     ...
     function p03Func(){
      ...
      document.getElementById("design").setAttribute("src","images/idliwiki.jpg");
        
        document.getElementById("js").setAttribute("src","images/idlisambhar.jpg");
       document.getElementById("another").setAttribute("src","images/idli2.jpg")
      
       }

       function p04Func(){
        document.getElementById("problem").innerHTML="<p>Chhole bhature is often eaten as a breakfast dish, sometimes accompanied with lassi. It can also be street food or a complete meal and may be accompanied with onions, pickled carrots, green chutney or achaar. Halwa Poori (Urdu:Ø­Ù„ÙˆÛ Ù¾ÙˆØ±ÛŒ) (Hindi: à¤¹à¤²à¤µà¤¾ à¤ªà¥‚à¤°à¥€) is a Pakistani dish with roots in the Indian subcontinent.</p>"
        document.getElementById("design").setAttribute("src","images/cholewiki.jpg");
          
          document.getElementById("js").setAttribute("src","images/chole.jpg");
         document.getElementById("another").setAttribute("src","images/chole2.jpg")
         ...
         function p05Func(){
          ...
          document.getElementById("design").setAttribute("src","images/pavbhajiwiki.jpg");
            
            document.getElementById("js").setAttribute("src","images/pavbhaji2.jpg");
           document.getElementById("another").setAttribute("src","images/pavbhaji.jpg")
